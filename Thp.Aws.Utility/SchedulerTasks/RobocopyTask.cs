...
namespace Thp.Har.Utility.SchedulerTasks {
    public class RobocopyTask : ITask {
        public const string Name = "RobocopyTask";

        public void HandleConditionsMetEvent(object sender, ConditionsMetEventArgs e) {
            var task = new RobocopyUtility();
            task.Execute();
            ...
            //        result = CommandLineUtility.ExecuteCommandLine(workingDirectory, CacheObject.Settings.RobocopyCommand, arguments, CacheObject.Settings.RobocopyUsername, CacheObject.Settings.RobocopyPassword, true);
            //    } else {
            //        result = CommandLineUtility.ExecuteCommandLine(null, CacheObject.Settings.RobocopyCommand, arguments, CacheObject.Settings.RobocopyUsername, CacheObject.Settings.RobocopyPassword, true);
            //    }
